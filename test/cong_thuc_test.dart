...
''';
  ...
  test('khong bat buoc 100 g: Pepsi 0/330, banh bo 240/100 log 50 = 120', () {
    final pepsi = CongThuc.tiLe(kcal: 0, gGoc: 330, gMoi: 330);
    expect(pepsi.gram, 330);
    expect(pepsi.kcal, 0);
    expect(CongThuc.tiLe(kcal: 0, gGoc: 330, gMoi: 165).kcal, 0);

    final logBo = CongThuc.tiLe(kcal: 240, gGoc: 100, gMoi: 50);
    expect(logBo.kcal, 120);
    expect(logBo.gram, 50);

    final khoi = CongThuc.tiLe(
      kcal: 520,
      gGoc: 250,
      gMoi: 125,
      dam: 40,
    ...
    expect(khoi.kcal, 260);
    expect(khoi.gram, 125);
    expect(khoi.dam, 20);
    expect(khoi.bot, 6);
    expect(khoi.beo, 14);
  });
